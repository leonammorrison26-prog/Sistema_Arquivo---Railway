...
function indicador_field_labels(): array
{
    return [
        ...
        'receb_guia' => 'Recebimento de Documentos - Guia de Transferência',
        'cx_sep_class' => 'Caixas separadas para classificação',
        'proc_class' => 'Processos/Documentos classificados',
        'cx_sep_eliminacao' => 'Caixas separadas para eliminação',
        'cx_listadas_eliminacao' => 'Caixas listadas para eliminação',
        'proc_listados_eliminacao' => 'Processos/Documentos listados para eliminação',
